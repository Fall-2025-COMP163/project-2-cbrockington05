...
AI Usage: ChatGPT helped me with method overriding methods
...
class Warrior(Player):
    ...
    def __init__(self, name):
        ...
        #warriors have more health and strength; low magic
...
class Mage(Player):
    ...
    def __init__(self, name):
        ...
        #mages have low health and strength; more magic
...
class Rogue(Player):
    ...
    def __init__(self, name):
        ...
        #rogues have a more balanced stat
    ...
    def attack(self, target):
        ...
        if crit_chance <= 3: #30% chance
            damage *= 2
            print(f"{self.name} lands critical hit for {damage} damage!")
        else:
            print(f"{self.name} attacks for {damage} damage!")
...
if __name__ == "__main__":
    ...
    #shows stats for each character
    print('\n📊 Character Stats:')
    warrior.display_stats()
    mage.display_stats()
    rogue.display_stats()
    ...
    #each character's attack is different
    print("\n⚔️ Testing Polymorphism (same attack method, different behavior):")
    ...
    #special abilities tester
    e1 = Character('Enemy 1', 50, 0 ,0)
    e2 = Character("Enemy 2", 50, 0, 0)
    e3 = Character('Enemy 3', 50, 0, 0)
    ...
    #show weapons
    sword = Weapon('Iron Sword', 10)
    wand = Weapon('Magic Wand', 15)
    dagger = Weapon('Steel Daggers', 8)
